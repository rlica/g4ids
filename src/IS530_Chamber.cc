...
G4VPhysicalVolume* IS530_Chamber::Construct()
{
  ...
  // DETECTOR PLACEMENT
    ...
    IS530_Chamber_name.push_back("../STL_export/Bucharest_Chamber/Bucharest_Chamber_IS530_capac_leon.stl");
    IS530_Chamber_name.push_back("../STL_export/Bucharest_Chamber/Bucharest_Chamber_IS530_incinta_leon.stl");
