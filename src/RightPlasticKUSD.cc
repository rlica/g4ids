...
RightPlasticKUSD::RightPlasticKUSD(G4String name)
  :G4VSensitiveDetector(name), detectorID(-1), HCID(-1)
{
  HC_name = "RightPlasticKU";
  collectionName.insert(HC_name);
//  detectorID = AddRightPlasticKUDetector(name);
}
                                                                                                                                                                                                                         
RightPlasticKUSD::~RightPlasticKUSD()
{;}

void RightPlasticKUSD::Initialize(G4HCofThisEvent* evnt)
{
  hitsCollection = new RightPlasticKUHitsCollection(SensitiveDetectorName, HC_name);
...
G4bool RightPlasticKUSD::ProcessHits(G4Step* aStep, G4TouchableHistory*)
{
...
*/
  ...
  RightPlasticKUHit* newHit = new RightPlasticKUHit();
...
void RightPlasticKUSD::EndOfEvent(G4HCofThisEvent*)
{;}
               
/*
G4int RightPlasticKUSD::AddRightPlasticKUDetector(G4String name){
...
G4int RightPlasticKUSD::AddRightPlasticKUDetector(){
  G4int det_id = detectors.size();
  ostringstream id_strm;
  id_strm.clear();
  id_strm << det_id;
  return( AddRightPlasticKUDetector("detRightPlasticKU" + id_strm.str()) );
}
*/
