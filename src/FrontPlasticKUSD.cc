...
FrontPlasticKUSD::FrontPlasticKUSD(G4String name)
  :G4VSensitiveDetector(name), detectorID(-1), HCID(-1)
{
  HC_name = "FrontPlasticKU";
  collectionName.insert(HC_name);
//  detectorID = AddFrontPlasticKUDetector(name);
}
                                                                                                                                                                                                                         
FrontPlasticKUSD::~FrontPlasticKUSD()
{;}

void FrontPlasticKUSD::Initialize(G4HCofThisEvent* evnt)
{
  hitsCollection = new FrontPlasticKUHitsCollection(SensitiveDetectorName, HC_name);
...
G4bool FrontPlasticKUSD::ProcessHits(G4Step* aStep, G4TouchableHistory*)
{
...
*/
  ...
  FrontPlasticKUHit* newHit = new FrontPlasticKUHit();
...
void FrontPlasticKUSD::EndOfEvent(G4HCofThisEvent*)
{;}
               
/*
G4int FrontPlasticKUSD::AddFrontPlasticKUDetector(G4String name){
...
G4int FrontPlasticKUSD::AddFrontPlasticKUDetector(){
  G4int det_id = detectors.size();
  ostringstream id_strm;
  id_strm.clear();
  id_strm << det_id;
  return( AddFrontPlasticKUDetector("detFrontPlasticKU" + id_strm.str()) );
}
*/
