...
CloverQuadDetector::CloverQuadDetector(G4VPhysicalVolume* p_mother, G4double p_rho, G4double p_theta, G4double p_phi, G4double p_spin, G4int p_cl_nb)
...
G4VPhysicalVolume* CloverQuadDetector::Construct()
{
    ...
    mesh_Capsule	= new CADMesh(const_cast<char*>("../STL_export/Clover_KULeuven_RefFace/Clover_Assembly_RefModif_capsule2_1.stl"),       mm,  G4ThreeVector(0*cm, 0*cm, 0*cm), false); // back to 08122015 
    mesh_CapsuleCap	= new CADMesh(const_cast<char*>("../STL_export/Clover_KULeuven_RefFace/Clover_Assembly_RefModif_Capsule_cap_2.stl"),    mm,  G4ThreeVector(0*cm, 0*cm, 0*cm), false); // back to 08122015 
    mesh_CarboneWindow	= new CADMesh(const_cast<char*>("../STL_export/Clover_KULeuven_RefFace/Clover_Assembly_RefModif_Carbone_window_3.stl"), mm,  G4ThreeVector(0*cm, 0*cm, 0*cm), false); // back to 08122015 
