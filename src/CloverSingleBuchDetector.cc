...
CloverSingleBuchDetector::CloverSingleBuchDetector(G4VPhysicalVolume* p_mother, G4Transform3D p_transformation, G4int p_cl_nb, G4int p_cr_nb, G4VisAttributes* pvis_att)
